...
2. Loads email addresses from unique_emails.json (generated by get_unique_emails.py)
...
- Email list: Generated by get_unique_emails.py or modify the 'default_emails' list in main() function
...
def main():
    ...
    parser.add_argument('--output', type=str, default="cascade_analytics_results.json",
                        help='Output JSON file name (default: cascade_analytics_results.json)')
    ...
    # Try to load emails from unique_emails.json
    emails_from_file = load_emails_from_file()
    ...
    if not emails:
        print("No emails found. Please run get_unique_emails.py first or add emails to the default_emails list.")
        return
